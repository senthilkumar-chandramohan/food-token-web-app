        ...
        if (permission === 'granted') {
          ...
          if ("serviceWorker" in navigator) {
            navigator.serviceWorker.register("/sw.js").then(async (registration) => {
                ...
                const response = await fetch(`https://192.168.0.112:443/get-app-server-key?accountID=${accountID}`);
                ...
                fetch(`https://192.168.0.112:443/add-subscription?accountID=${accountID}`, {
                    method: 'POST',
                    headers: {
